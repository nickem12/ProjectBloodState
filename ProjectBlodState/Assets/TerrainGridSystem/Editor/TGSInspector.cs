...
//			EditorGUILayout.BeginHorizontal ();
//			GUILayout.Label ("Max Cell Count", GUILayout.Width (120));
//			tgs.maxCellCount = EditorGUILayout.IntField (tgs.maxCellCount, GUILayout.Width(60));
//			EditorGUILayout.EndHorizontal ();

			if (tgs.gridTopology == GRID_TOPOLOGY.Irregular) {
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Cells (aprox.)", GUILayout.Width (120));
//				tgs.numCells = EditorGUILayout.IntSlider (tgs.numCells, 2, tgs.maxCellCount);
				tgs.numCells = EditorGUILayout.IntField (tgs.numCells, GUILayout.Width(60));
				EditorGUILayout.EndHorizontal ();
			} else {
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Columns", GUILayout.Width (120));
//				tgs.columnCount = EditorGUILayout.IntSlider (tgs.columnCount, 2, tgs.maxCellsSqrt * 2);
				tgs.columnCount = EditorGUILayout.IntField (tgs.columnCount, GUILayout.Width(60));
				EditorGUILayout.EndHorizontal ();
				EditorGUILayout.BeginHorizontal ();
				GUILayout.Label ("Rows", GUILayout.Width (120));
//				tgs.rowCount = EditorGUILayout.IntSlider (tgs.rowCount, 2, tgs.maxCellsSqrt * 2);

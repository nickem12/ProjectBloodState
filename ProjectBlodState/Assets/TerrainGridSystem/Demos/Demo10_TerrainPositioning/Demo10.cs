...
namespace TGS {
	public class Demo10 : MonoBehaviour {
		...
		IEnumerator MoveGrid() {
			...
			// x = (gridCenterX - gridWidth * 0.5 + gridColumnsAroundPosition * 0.5) / gridColumnsAroundPosition
			// y = (gridCenterY - gridHeight * 0.5 + gridRowsAroundPosition * 0.5) * gridRowsAroundPosition

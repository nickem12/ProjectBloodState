...
//		/// <summary>
//		/// Returns true if map has been regenerated
//		/// </summary>
//		void CheckRowColumnCount() {
//			maxCellsSqrt = Mathf.FloorToInt(Mathf.Sqrt (_maxCellCount));
//			bool regenerateMap = false;
//			if (_cellRowCount * _cellColumnCount >= _maxCellCount) {
//				_cellRowCount = maxCellsSqrt;
//				_cellColumnCount = maxCellsSqrt;
//				regenerateMap = true;
//			}
//			if (_numCells >= _maxCellCount) {
//				_numCells = _maxCellCount;
//				regenerateMap = true;
//
//			}
//			if (regenerateMap) {
...
//		}
		...
		void CreateCells ()
		{
			...
			_numCells = Mathf.Max (_numTerritories, 2, cellCount); // Mathf.Clamp (_numCells, Mathf.Max (_numTerritories, 2), _maxCellCount);
			if (cells == null) {
